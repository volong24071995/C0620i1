                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <strong>Update ProductLine</strong>
                                </div>
                                    ...
                                    <form action="" method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="hidden" name="id" id="id" size="45" value="${productLine.getMaTheLoai()}" />
                                                <input type="text" id="name-input" name="name" value="${productLine.getTenTheLoai()}" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="moTa" id="textarea-input" rows="9" placeholder="Content..." class="form-control">${productLine.getMoTa()}</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="submit" id="email-input" name="email-input" class="form-control" value="Save">
                                            </div>
                                        </div>
                                    </form>
                                </div>
