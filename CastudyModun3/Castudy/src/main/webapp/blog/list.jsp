    ...
    <div class="page-container">
            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="header-wrap">
                        <form class="form-header" action="/Blog?action=search" method="post">
        ...
        <div class="main-content">
            ...
            <div class="section__content section__content--p30">
                <div>
                    <h3>
                        <a href="/Blog?action=create">Create</a>
                    </h3>
                </div>
                <table class="table table-striped">
                    ...
                    <c:forEach var="blog" items="${blogList}">
                        <tr>
                            ...
                            <td><c:out value="${blog.link}"/></td>
                            <td>
                                <a href="/Blog?action=edit&id=${blog.id}"><i class="material-icons">&#xE254;</i></a>
                                <a href="/Blog?action=delete&id=${blog.id}"><i class="material-icons">&#xE872;</i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
