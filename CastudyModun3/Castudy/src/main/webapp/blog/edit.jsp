                                    ...
                                    <form action=" " method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="hidden" name="id" id="id" size="45" value="${blog.id}"/>
                                                <input type="text" id="name-input" name="title" value="${blog.title}" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="price-input" name="link" value="${blog.link}" class="form-control"required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="img-input" name="image" value="${blog.getImage()}" class="form-control"required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
