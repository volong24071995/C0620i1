            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="header-wrap">
                        <form class="form-header" action="/products?action=search" method="post">
            ...
            <div class="section__content section__content--p30">
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach var="product" items="${productList}">
                        <tr>
                            <td><c:out value="${product.maSanPham}"/></td>
                            <td><a href="/products?action=view&id=${product.maSanPham}"><c:out value="${product.tenSanPham}"/></a></td>
                            <td><c:out value="${product.giaSanPham}"/></td>
                            <td><c:out value="${product.loaiSanPham.tenTheLoai}"/></td>
                            <td><c:out value="${product.nhaSanXuat.tenNhaSanXuat}"/></td>
                            <td><c:out value="${product.soLuong}"/></td>
                            <td><c:out value="${product.soLuongMua}"/></td>
                            <td>
                                <a href="/products?action=edit&id=${product.maSanPham}"><i class="material-icons">&#xE254;</i></a>
                                <a href="/products?action=delete&id=${product.maSanPham}"><i class="material-icons">&#xE872;</i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
