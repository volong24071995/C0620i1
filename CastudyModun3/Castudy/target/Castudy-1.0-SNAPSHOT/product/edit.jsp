                                    ...
                                    <form action=" " method="post" class="form-horizontal">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="hidden" name="id" id="id" size="45" value="${product.getMaSanPham()}"/>
                                                <input type="text" id="name-input" name="name" value="${product.getTenSanPham()}" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="price-input" name="price" value="${product.getGiaSanPham()}" class="form-control"required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="img-input" name="image" value="${product.getImage()}" class="form-control"required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="color-input" name="mauSac" value="${product.getMauSac()}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="amount-input" name="amount" value="${product.getSoLuong()}" class="form-control"required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="type" id="productLine" class="form-control">
                                                    <c:forEach items="${productLines}" var="productLine">
                                                        <c:if test="${product.loaiSanPham.tenTheLoai==productLine.getTenTheLoai()}">
                                                        <option value="${productLine.getMaTheLoai()}" selected>${productLine.getTenTheLoai()}</option>
                                                        </c:if>
                                                        <c:if test="${!(product.loaiSanPham.tenTheLoai==productLine.getTenTheLoai())}">
                                                            <option value="${productLine.getMaTheLoai()}" >${productLine.getTenTheLoai()}</option>
                                                        </c:if>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select name="vendor" id="ProductVendor" class="form-control">
                                                    <c:forEach items="${productVendors}" var="productVendor">

                                                        <c:if test="${product.nhaSanXuat.tenNhaSanXuat==productVendor.getTenNhaSanXuat()}">
                                                        <option value="${productVendor.getMaNhaSanXuat()}" selected>${productVendor.getTenNhaSanXuat()}</option>
                                                        </c:if>
                                                        <c:if test="${!(product.nhaSanXuat.tenNhaSanXuat==productVendor.getTenNhaSanXuat())}">
                                                            <option value="${productVendor.getMaNhaSanXuat()}" >${productVendor.getTenNhaSanXuat()}</option>
                                                        </c:if>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="date" id="begin-input" name="begin" value="${product.getNgaySanXuat()}" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="date" id="end-input" name="end" value="${product.getHanSudung()}" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="mota" id="textarea-input" rows="9" class="form-control">${product.getMoTa()}</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
